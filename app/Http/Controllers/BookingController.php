...
class BookingController extends Controller
{
    ...
    public function bookingstatus(Request $request, $id)
    {
        ...
        if ($bookingdata->bookingPackage == null && $bookingdata->discount !== null) {
            $bookingdata->final_discount_amount = ($bookingdata->service->price * $bookingdata->quantity * $bookingdata->discount) / 100;
        }
