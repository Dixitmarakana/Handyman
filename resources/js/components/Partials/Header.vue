            ...
            <div class="header-left d-flex align-itens-center">
                <a href="#" class="navbar-brand">
                    <router-link :to="{ name: 'frontend-home' }">
                        <img v-if="generalsetting.site_logo" :src="generalsetting.site_logo" class="img-fluid logo" />
                        <img v-else :src="baseUrl + '/images/logo.svg'" class="img-fluid logo" />
                    </router-link>
                </a>
            ...
            <div class="header-right d-flex align-itens-center">
                ...
                <div class="location-device-sm position-relative">
                    <div class="header-address" @click="$bvModal.show('nearlocation')">
                          <span class="icon" >
                            <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5 8.50051C11.5 7.11924 10.3808 6 9.00051 6C7.61924 6 6.5 7.11924 6.5 8.50051C6.5 9.88076 7.61924 11 9.00051 11C10.3808 11 11.5 9.88076 11.5 8.50051Z" stroke="#008fb2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M8.99951 19C7.80104 19 1.5 13.8984 1.5 8.56329C1.5 4.38664 4.8571 1 8.99951 1C13.1419 1 16.5 4.38664 16.5 8.56329C16.5 13.8984 10.198 19 8.99951 19Z" stroke="#008fb2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                          </span>
